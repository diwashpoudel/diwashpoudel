          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">
                <a href="{{ route('banner.index') }}">Banner Listing</a></li>
                <li class="breadcrumb-item active">
                   Banner Listing</li>
              ...
              <div class="card-body p-0">
                <div class="d-md-flex">
                  <div class="p-3 flex-fill" style="overflow: hidden">
                    @if(isset($detail))
                    {{Form::open(['url'=>route('banner.update',$detail->id) , 'class'=>'form ','files'=>true ])}}
                    @method('patch')
                    @else
                    ...
                    <div class="form-group row">
                       ...
                       <div class="col-sm-9">
                         {{ Form::text('title',@$detail->title,['class'=>'form-control form-control-sm','required'=>'true','placeholder'=>'Enter Your Banner Title Here' ,'id'=>'title']) }}
                        @error('title')
                     ...
                     <div class="form-group row">
                       ...
                       <div class="col-sm-9">
                         {{ Form::url('link', @$detail->link,['class'=>'form-control form-control-sm','required'=>'true','placeholder'=>'Enter Your Banner link Here' ,'id'=>'link']) }}
                        @error('link')
                        <span class="text-danger">{{ $message }}</span>
              ...
              <div class="col-sm-3">
                  ...
                  <div class="col-sm-2">
                    @if(isset($detail) && $detail->image !== null)
                      @php $url = asset('uploads/banner/'.$detail->image);@endphp
                      @else
